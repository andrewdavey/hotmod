...
namespace Hotmod
{
    public class HotFilter : MemoryStream
    {
        ...
        public HotFilter(Stream outputStream, HttpContextBase httpContext, HotmodSection config)
        {
        ...
        public override void Close()
        {
            ...
            XDocument document;
            if (!TryParseHtmlWithErrorHandling(html, out document))
            {
                base.Close();
                return;
            }
